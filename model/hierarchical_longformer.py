...
class HierarchicalLongformerForSequenceClassification(LongformerPreTrainedModel):
...
#         self.classifier = HierarchicalLongformerClassificationHead(config)
    ...
    def forward(
        ...
        doc_ids = torch.tensor(doc_ids, dtype=torch.int64).to(
            cls_embeddings.get_device()
        )
